...
#            print(attention_option.size())
            context_concat_out, (context_concat_hid, o2) = self.rnn2(torch.cat((context_out, attention_context, context_out*attention_context, context_out-attention_context), -1))
            option_concat_out, (option_concat_hid, o3) = self.rnn2(torch.cat((option_out, attention_option, option_out*attention_option, option_out-attention_option), -1))
