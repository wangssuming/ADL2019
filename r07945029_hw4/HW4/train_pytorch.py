...
def main():
    ...
    parser.add_argument("--test_path", type=str, dest='test_path', help="test path")
    parser.add_argument("--img_dir", type=str, dest='img_dir', help="image path")
    parser.add_argument("--ckpt_dir", type=str, default='./checkpoint/', help="ckpt path")
...
#        for ep in range(1,600):
        ...
        discriminator.eval()
        if opt.test_path and opt.img_dir:
            test_path = opt.test_path
            image_dir = opt.img_dir
        else:
            print('no test path or image path')
            return
